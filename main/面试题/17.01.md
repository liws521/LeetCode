...
```Java
我们知道异或运算^是不进位的加法，因此要实现加法的第一步就是先用异或运算^进行不进位加法
...
作者：Zero1018
链接：https://leetcode-cn.com/problems/add-without-plus-lcci/solution/java-wei-yun-suan-chao-100si-lu-qing-xi-g1h59/
来源：力扣（LeetCode）
